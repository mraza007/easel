...
/**
 * Hardcoded sample so the canvas shows real content before the MCP server is
 * wired up. Replace with empty array once write_html is functional.
 */
export const SAMPLE_ARTBOARDS: Artboard[] = [
  {
    id: "ab-hero",
    tag: "artboard",
